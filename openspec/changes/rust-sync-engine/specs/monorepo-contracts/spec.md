...
#### Scenario: Rust service included in workspace

- **WHEN** the workspace includes `services/rust-sync-engine/`
- **THEN** pnpm SHALL recognize it as a workspace member (Cargo-based, no node_modules)
